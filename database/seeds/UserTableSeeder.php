...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user_suped           = new User();
        $user_suped->name     = 'I am User Supes';
        $user_suped->email    = 'user_suped@test.com';
        $user_suped->password = bcrypt('secret');
        $user_suped->save();
        $user_suped->roles()->attach($manager_role);
        $user_suped->permissions()->attach($dev_create_perm);
        $user_suped->permissions()->attach($dev_delete_perm);
        $user_suped->permissions()->attach($manager_perm);
    }
}